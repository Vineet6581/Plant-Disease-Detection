# SmartCrop 🌿 - Intelligent Plant Disease Classifier

Developed as part of [B.tech/Abes Engineering College] Project by [Vineet Kumar]
...
[**Live Demo**](git clone https://github.com/Vineet6581/Plant-Disease-Detection.git)
...
## 👨‍💻 Author
This project was developed by vineet kumar with other 2 mates, as a part of course B.tech(IT) in ABES engineering college

## 🧠 Improvements Made
- Added support for Random Forest, Naive Bayes, and KMeans.
- Customized UI and user experience.
- Retrained model on custom data subset.
